...
INT __stdcall WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR lpCmdLine, INT nCmdShow)
{
    ...
    LPVOID mem = VirtualAllocEx(handle, NULL, dll_name.size(), MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);

    // Write the argument to LoadLibraryA
    int n = WriteProcessMemory(handle, mem, dll_name.c_str(), dll_name.size(), NULL);
